...
// [BL] Doom 64 has a slightly different format
struct mapvertexdoom64_t
{
	fixed_t x, y;
};
...
enum EMapThingFlags
{
	...
	*/
	...
	D64TF_NOTSINGLE		= 0x0010,
	D64TF_DONTSPAWN		= 0x0020,	// Spawned when triggered.  Possibly the same as DORMANT
	D64TF_ONTOUCH		= 0x0040,	// Triggers
	D64TF_ONDEATH		= 0x0080,
	D64TF_SECRET		= 0x0100,	// Secret pickup
	D64TF_NOINFIGHTING	= 0x0200,
	D64TF_NOTDEATHMATCH	= 0x0400,
