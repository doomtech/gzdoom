...
private:
	...
	void PortalTop(seg_t * seg,sector_t * fs,sector_t * bs,vertex_t * v1,vertex_t * v2);
	void PortalBottom(seg_t * seg,sector_t * fs,sector_t * bs,vertex_t * v1,vertex_t * v2);
	...
	void FillPortal(seg_t * seg, FPortal *_portal,
